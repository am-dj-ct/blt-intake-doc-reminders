...
async function launch({ headless = true, profileDir } = {}) {
  ...
  // Keep the browser SDK at the operation boundary. Date/schedule helpers and
  // the orchestrator can then load without Playwright in processes that never
  // launch a browser (for example, focused unit-test and health-check paths).
