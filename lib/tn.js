...
//   ok         — the day grid visibly rendered (`.calendar-daybubble` showed
//                up in time). false means a load failure — an empty scrape
//                from that is NOT proof of an empty schedule.
...
async function gotoDay(page, dateStr) {
  ...
  try {
    await page.waitForSelector('.calendar-daybubble', { timeout: 15000 });
