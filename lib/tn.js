...
async function launch({ headless = true, profileDir } = {}) {
  ...
  // Keep Playwright at the browser boundary. Most of this module is pure
  // schedule/date parsing and is imported by the unit-testable orchestrator;
  // eagerly resolving the browser package made every one of those consumers
  // fail at require-time in environments that intentionally omit runtime-only
